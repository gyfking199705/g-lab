...
| **ai-coding-lab** | AI Coding 研究室：收集并展示 AI 编程范式与提效方式（范式/工作流/技巧/工具/护栏）。别的 agent 可直接读 [`KNOWLEDGE.md`](projects/ai-coding-lab/KNOWLEDGE.md) 吸收全部精华、读 [`AGENTS.md`](projects/ai-coding-lab/AGENTS.md) 扩展 | `…/g-lab/projects/ai-coding-lab/` | `cd projects/ai-coding-lab && npm i --no-save esbuild react@18.3.1 react-dom@18.3.1 && node build.mjs` |
