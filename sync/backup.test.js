...
test('BACKUP_KEYS：不含含密键，含各模块数据键', () => {
  ...
  for (const k of ['learning-planner', 'fitness-planner', 'savings-planner', 'stocks-watch', 'schedule-planner', 'goals-planner', 'habits-planner', 'cut-planner', 'papers-planner', 'ledger-planner']) {
