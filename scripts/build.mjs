...
await build({ ...common, entryPoints: ['ui/demo/bootstrap.jsx'], outfile: 'dist/ui.js' });
...
for (const m of ['savings', 'learning', 'fitness', 'project', 'schedule', 'goals', 'habits', 'cut', 'papers', 'ledger', 'compare', 'salary', 'ui']) {
