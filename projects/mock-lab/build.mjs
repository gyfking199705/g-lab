/**
 * Mock 研究室 打包脚本：把 React 应用打成自托管单文件 bundle（含 React，无外部 CDN）。
 *   cd projects/mock-lab && npm i --no-save esbuild react@18.3.1 react-dom@18.3.1 && node build.mjs
...
console.log('✅ mock-lab 已打包：dist/app.js（已写入 ?v= 缓存号）');
